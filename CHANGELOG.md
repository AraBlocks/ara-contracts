# [0.13.0](https://github.com/AraBlocks/ara-contracts/compare/0.3.0...0.13.0) (2018-12-12)


### Bug Fixes

* add jobID tohex ([f9ec4e2](https://github.com/AraBlocks/ara-contracts/commit/f9ec4e2))
* add return value to README ([76b7502](https://github.com/AraBlocks/ara-contracts/commit/76b7502))
...
* contract event updates and fix [#152](https://github.com/AraBlocks/ara-contracts/issues/152) ([9c6922b](https://github.com/AraBlocks/ara-contracts/commit/9c6922b))
